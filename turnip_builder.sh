...
zip -r $workdir/turnip-23.3.0-cairetina.adpkg.zip * &> /dev/null
if ! [ -a $workdir/turnip-23.3.0-cairetina.adpkg.zip ];
	then echo -e "$red-Packing failed!$nocolor" && exit 1
	else echo -e "$green-All done, you can take your module from here;$nocolor" && echo $workdir/turnip-23.3.0-cairetina.adpkg.zip
fi
